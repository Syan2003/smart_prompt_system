...
function WebSocketConnectMethod( config ) { //定义socket连接方法类
	...
	this.wsStart = function () {
		var Uri = "wss://www.funasr.com:10096/"; //"wss://111.205.137.58:5821/wss/" //设置wss asr online接口地址 如 wss://X.X.X.X:port/wss/
	...
	function onOpen( e ) {
		...
		var request = {
			...
			"chunk_interval":10,
			"itn":false,
			"mode":"2pass", // "2pass" "online" "offline" 2place 
			
		};
		
		var hotwords=JSON.stringify({"你好":"20"});
