...
.main .box #content .con_text {
    color: #333;
    margin-bottom: 5px;
}

.main .box #content .con_que {
    color: #1c88ff;
    height: 30px;
    line-height: 30px;
    cursor: pointer;
...
.main .box #content .info_r {
    position: relative;
}

.main .box #content .info_r .circle_r {
    position: absolute;
    left: 0%;
}

.main .box #content .info_r .pic_r {
    width: 17px;
    height: 17px;
    margin: 8px;
}

.main .box #content .info_r .con_r {
    display: inline-block;
    width: 55%;
    min-height: 55px;
...
.main .box #content .info_r .time_r {
    margin-left: 45px;
    color: #999999;
    font-size: 12px;
}

.main .box #content .info_l {
    text-align: right;
    color: #3163C5;
    margin-top: 10px;
}

.main .box #content .info_l .pic_l {
    width: 13px;
    height: 17px;
    margin: 8px 10px;
}

.main .box #content .info_l .time_l {
    margin-right: 45px;
    color: #999999;
    font-size: 12px;
    margin-top: 5px;
...
.czkj-item-question .czkj-question-msg {
    float: left;
    font-size: 14px;
    color: #3163C5;
}
